...
public class DoubleArraySequence {
   ...
   {
      //DoubleArraySequence d3 = new DoubleArraySequence();
    ...
    *                then the new element is placed at the end of the sequen  ce. In
   ...
   public void addAll(DoubleArraySequence addend) 
   {
         ...
         if(addend==null)
            ...
            //if(manyItems &&  < data.length)//check manyitemns && any items and the capacity data.length make sure the cpapciy is equal to the other one) maneyItem+addend.maneyItems
   ...
   public static DoubleArraySequence catenation(DoubleArraySequence s1, DoubleArraySequence s2) 
   {
      ...
      DoubleArraySequence a = new DoubleArraySequence(s1);
      for (int i = 0; i < s2.manyItems; i++) 
      {
         a.addAfter(s2.data[i]);
      }
      a.currentIndex++;
   ...
   public void ensureCapacity(int minimumCapacity) 
   {
      ...
      {
         double[] numbers = new double[minimumCapacity];
